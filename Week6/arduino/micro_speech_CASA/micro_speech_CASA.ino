...
/*
  Setup function - initialise settings, runs once at power up
*/
...
void setup() {
  ...
  //
  // more info on operations available: 
  // https://github.com/tensorflow/tensorflow/blob/master/tensorflow/lite/micro/micro_mutable_op_resolver.h
  //
...
/*
  Loop function runs continuously after set-up
*/
